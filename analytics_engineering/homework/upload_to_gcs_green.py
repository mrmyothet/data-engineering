...
BUCKET_NAME = "ny_taxi_data_mt"
GOOGLE_CREDENTIALS_JSON = "../.google/credentials/google_credentials.json"

client = storage.Client.from_service_account_json(GOOGLE_CREDENTIALS_JSON)
