-- MAKE SURE YOU REPLACE ny-rides-mt WITH THE NAME OF YOUR DATASET! 
...
ALTER TABLE `ny-rides-mt.trips_data_all.yellow_tripdata`
...
ALTER TABLE `ny-rides-mt.trips_data_all.green_tripdata`
  RENAME COLUMN vendor_id TO VendorID;
ALTER TABLE `ny-rides-mt.trips_data_all.green_tripdata`
